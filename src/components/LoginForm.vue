<template>
  <ElCard>
    <template #header>
      <div class="text-center font-bold text-2xl">Login</div>
    </template>
    <ElForm :model="loginForm" label-position="top">
      ...
      <ElFormItem>
        <ElButton @click="login(loginForm)" class="w-screen">Login</ElButton>
      </ElFormItem>
    </ElForm>
  </ElCard>
</template>
